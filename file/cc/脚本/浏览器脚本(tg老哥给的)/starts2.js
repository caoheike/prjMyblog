  ...
  async function addsession() {
    try {
      ...
      solving({
        ...
        console.log('User-Agent: ' + random_ua + ' ');
        console.log('Cookie: ' + myString + ' ');
    ...
    chromium.launch({
      ...
      await page.waitForTimeout(10000, {
		...
		const response = await gotosite.status();
          ...
          console.log('No bypassing // STRESSID.CLUB');
		  await context.close();
          await browser.close();
		  reject(error1);
        }
		...
		try {
			...
			if (cookies) {
			  console.log('Get cookie // STRESSID.CLUB');
			  resolve(cookies);
			  await context.close();
			  await browser.close();
			  return;
